 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.process.process.impl.VariableReferenceImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableReferenceImpl extends ExpressionImpl implements VariableReference
{
  ...
  {
    return ProcessPackage.Literals.VARIABLE_REFERENCE;
  }
    ...
    if (variable != null && variable.eIsProxy())
    {
      ...
      if (variable != oldVariable)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.VARIABLE_REFERENCE__VARIABLE, oldVariable, variable));
      }
    }
    return variable;
  }
  ...
  public void setVariable(VariableDeclaration newVariable)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.VARIABLE_REFERENCE__VARIABLE, oldVariable, variable));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProcessPackage.VARIABLE_REFERENCE__VARIABLE:
