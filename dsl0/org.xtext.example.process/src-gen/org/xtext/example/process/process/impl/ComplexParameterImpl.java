 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.process.process.impl.ComplexParameterImpl#getVariables <em>Variables</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexParameterImpl extends ParameterImpl implements ComplexParameter
{
  ...
  {
    return ProcessPackage.Literals.COMPLEX_PARAMETER;
  }
  ...
  public EList<VariableDeclaration> getVariables()
  {
    if (variables == null)
    {
      variables = new EObjectContainmentEList<VariableDeclaration>(VariableDeclaration.class, this, ProcessPackage.COMPLEX_PARAMETER__VARIABLES);
    }
    return variables;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProcessPackage.COMPLEX_PARAMETER__VARIABLES:
